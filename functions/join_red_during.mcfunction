...
give @a[team=!red,team=!blue] diamond{Enchantments: [{id: "minecraft:sharpness", lvl: 2s}], display: {Name: '[{"text":"{ ","color":"gray","bold":true},{"text":"선택의 돌","color":"#A8BFFF","bold":true,"italic":false,"underlined":true},{"text":" }","color":"gray","bold":true}]', Lore: ['{"text":" 이 아이템을 가지고 상점에","color":"#A3FF47","bold":false,"italic":false}', '{"text":"방문하여 무기를 선택해주세요","color":"#A3FF47","bold":false,"italic":false}']}, CustomModelData: 1, HideFlags: 127} 1
item replace entity @s[team=!red,team=!blue] armor.chest with leather_chestplate{display:{color:16711680},Unbreakable:1b,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}]} 1
...
spreadplayers 211 193 0.5 2 false @s[team=!red,team=!blue]
team join red @s[team=!red,team=!blue]